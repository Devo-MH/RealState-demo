...
const TopVillas = () => {
  return (
    <section id="topVillas">
      ...
      <p>
        Discover our handpicked selection of villas offering the perfect blend of 
        luxury, comfort, and breathtaking locations. Each villa is thoughtfully 
        designed to provide you with unforgettable stays — whether for family 
        getaways, romantic escapes, or relaxing retreats.
      </p>
